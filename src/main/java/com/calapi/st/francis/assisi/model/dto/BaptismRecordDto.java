...
public class BaptismRecordDto {
	...
	public String toString() {
		return "BaptismRecordDto [childUuid=" + childUuid + ", firstName=" + firstName + ", middleName=" + middleName
				+ ", lastName=" + lastName + ", dateOfBirth=" + dateOfBirth + ", placeOfBirth=" + placeOfBirth
				+ ", dateOfBaptism=" + dateOfBaptism + ", placeOfBaptism=" + placeOfBaptism + ", fatherFirstName="
				...
				+ ", motherLastName=" + motherLastName + ", parentsAddress=" + parentsAddress + ", ageCategory="
				+ ageCategory + ", sponsors=" + sponsors + ", minister=" + minister + ", priestInCharge="
				+ priestInCharge + ", bookNo=" + bookNo + ", pageNo=" + pageNo + ", lineNo=" + lineNo + "]";
	}
